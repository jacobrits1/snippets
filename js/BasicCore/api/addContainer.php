...
$attachments = array();
//sendEmail('jaco@mobileeapps.com','Debug Email',,$attachments);
$dataArray = array('log_date' => date("Y-m-d H:i:s"),
                   'log_detail' => serialize($postData));
rowInsert($databaseConnection,'log',$dataArray);
...
if($postData->send_exporter  == '1'){
    sendEmail('jaco@mobileeapps.com',$subject,$body,$attachments);
    sendEmail('ansgarflaatten@gmail.com',$subject,$body,$attachments);
}
