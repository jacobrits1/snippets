...
function sentPasswordSMS($body, $mobile) {
    $username = 'Mobileeapps';
    $password = 'bulksmsft6ju7';
    /*
    * Your phone number, including country code, i.e. +44123123123 in this case:
    */
    $msisdn = '27'.(int)$mobile;
    ...
    */
    $post_body = seven_bit_sms( $username, $password, $msg_code, $msisdn );
   ...
   // print_ln("Script ran to completion");
	return "Script ran to completion";
}
