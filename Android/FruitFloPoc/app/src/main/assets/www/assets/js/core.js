  ...
  $('body').on('click', '.button', function(){
	...
	case 'updateProfile':
     ...
     currentUserRole = getCookie("ffrole");
         ...
         var dataJson = { 'username': currentUserName,
          ...
          $.ajax({
              type: "POST",
              url: "https://fruitflo.medmin.co.za/app/api2/updateProfile.php",
              data: dataJson,
              dataType: "json",
	...
	break;
      ...
      case 'login':   // login action getss username and password from index and check it against db
          ...
          $.ajax({
              type: "POST",
              url: "https://fruitflo.medmin.co.za/app/api2/login.php",
              data: dataJson,
              dataType: "json",
              success: function(data){
                console.log(data);
      ...
      case 'register':
           ...
           var dataJson = {'registerPuc': registerPuc,
              ...
              $.ajax({
                  type: "POST",
                  url: "https://fruitflo.medmin.co.za/app/api2/register.php",
                  data: dataJson,
                  dataType: "json",
                  success: function(data){
					console.log(data);
      ...
      case 'updatePassword':
            ...
            $.ajax({
                type: "POST",
                url: "https://fruitflo.medmin.co.za/app/api2/updatePassword.php",
                data: dataJson,
                dataType: "json",
                success: function(data){
					currentUserName = data.name;
      ...
      case 'resetPassword':
            ...
            $.ajax({
                type: "POST",
                url: "https://fruitflo.medmin.co.za/app/api2/resetPassword.php",
                data: dataJson,
                dataType: "json",
                success: function(data){
					console.log(data);
      ...
      case 'stepSend':
            ...
            $.ajax({
                type: "POST",
                url: "https://fruitflo.medmin.co.za/app/api2/addContainer.php",
                dataType: "json",
                contentType: false,
                processData: false,
								cache : false,
